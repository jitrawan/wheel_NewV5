...
<div class="panel panel-primary">
     <div class="panel-heading">การตั้งค่าการใช้งาน</div>
         <div class="panel-body">
          ...
          <a href="?p=setting_shelf1" class="btn btn-primary btn_main_wd"><i class="fa fa-archive fa-fw fa-6x"></i><br/><br/>สถานที่จัดเก็บสินค้า</a>
          ...
          <a href="?p=setting_model" class="btn btn-primary btn_main_wd"><i class="fa fa-cube fa-fw fa-6x"></i><br/><br/>รุ่นสินค้า</a-->
            <a href="?p=waitCutShelf" class="btn btn-primary btn_main_wd"><i class="fa fa-exclamation-triangle fa-fw fa-6x"></i><br/><br/>สินค้าที่ขายรอหักจากที่จัดเก็บ</a>
